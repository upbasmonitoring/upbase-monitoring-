            ...
            <div className="relative z-10 w-full max-w-md px-6 flex flex-col items-center">
                ...
                <div className="bg-white w-full p-10 rounded-[40px] border border-slate-100 shadow-[0_30px_70px_-20px_rgba(0,0,0,0.06)] relative overflow-hidden group">
                    ...
                    <div className="text-center mb-10 space-y-2">
                        <h2 className="text-2xl font-bold uppercase tracking-tighter text-slate-900">Create <span className="text-primary">Account</span></h2>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[.4em]">Start Infrastructure Monitoring</p>
                    </div>
                    ...
                    <div className="relative my-10 flex items-center justify-center">
                        ...
                        <span className="relative z-10 px-5 bg-white text-[9px] font-bold uppercase tracking-[.5em] text-slate-300">Fast Sync</span>
                    </div>
